  ...
  return (
    <div className="flex min-h-full flex-col bg-background text-foreground">
      ...
      <main className="flex-1">
        ...
        <section className="relative overflow-hidden px-6 pt-20 pb-24 sm:pt-28 sm:pb-32">
          ...
          <div className="mx-auto max-w-3xl text-center">
            ...
            >
              Software e inteligencia artificial · Argentina
            </p>
            ...
            >
              Argencore Solutions es una empresa argentina de desarrollo de
              software e inteligencia artificial. Creamos productos propios y
              soluciones a medida para que las empresas trabajen mejor.
            </p>
          ...
          <div className="mx-auto max-w-3xl px-6 text-center">
            <Reveal>
              ...
              <p className="mt-6 text-lg leading-relaxed text-muted">
                Somos una empresa argentina de tecnología enfocada en desarrollo
                de software e inteligencia artificial. Combinamos el trabajo por
                proyectos con el desarrollo de productos propios, como
                ArgencoreAI, buscando siempre el mismo resultado: soluciones
                claras, bien construidas y que le sirvan de verdad a quien las
                usa.
              </p>
            </Reveal>
          </div>
            ...
            <div className="relative mx-auto max-w-4xl overflow-hidden rounded-3xl border border-border bg-surface px-6 py-16 text-center">
              ...
              <div className="relative">
                ...
                <p className="mx-auto mt-4 max-w-md text-muted">
                  Contanos qué necesita tu empresa y te respondemos por
                  WhatsApp.
                </p>
                <a
                  href={WHATSAPP_URL}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group mt-9 inline-flex items-center gap-2.5 rounded-full bg-blue px-8 py-4 text-base font-medium text-white transition-all duration-300 hover:-translate-y-0.5 hover:shadow-xl hover:shadow-blue/30"
                >
                  <WhatsAppIcon className="h-5 w-5 transition-transform duration-300 group-hover:rotate-12" />
      ...
      <footer className="border-t border-border py-10">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-5 px-6 text-sm text-muted sm:flex-row">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 text-navy transition-colors hover:text-blue"
          >
            <WhatsAppIcon className="h-4 w-4" />
            +54 9 11 2171-1289
          </a>
